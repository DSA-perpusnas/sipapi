    ...
    public function index(Request $request)
    {
        ...
        if($user->isSuperAdmin()){
            ...
            foreach($accreditations as $data){
                array_push($accreditationsData, [
                    'id' => $data['id'],
                    'type' => $data['type'],
                    'code' => $data['code'],
                    'npp' => $data['institution']['npp'],
                    'institution_id' => $data['institution']['id'],
                    'agency_name'=> $data['institution']['agency_name'],
                    'library_name'=> $data['institution']['library_name'],
                    'institution_category'=> $data['institution']['category'],
                    'region_name'=> $data['institution']['region']['name'],
                    'province_name'=> $data['institution']['province']['name'],
                    'city_type'=> $data['institution']['city']['type'],
                    'city_name'=> $data['institution']['city']['name'],
                    'subdistrict_name'=> $data['institution']['subdistrict']['name'],
                    'institution_address'=> $data['institution']['address'],
